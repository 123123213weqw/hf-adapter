...
- NVIDIA GeForce RTX 3090 (`sm_86`): the 2026-08-12 latest-checkpoint
  dense-FP16 B1/B8 P128/P512/P2048 matrix may use only the exact row-32 scan
  ...
  against full-FLA/Triton-conv Qwen3.5, and all 15 prompt/cache-handoff
  correctness rows must remain green. Other Ampere products, model shapes,
  batches, and token blocks must not inherit these routes.
