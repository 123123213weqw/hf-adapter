# Historical agent milestones through 2026-07

> **Historical archive.** This is the pre-cleanup `AGENTS.md` snapshot. It preserves dated optimization milestones, commands, and rationale, but does not override the current root `AGENTS.md`, `HF_STATUS.md`, `HF_TODO.md`, `BENCHMARK.md`, or accepted benchmark artifacts.
