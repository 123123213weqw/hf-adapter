# Apple Silicon contributor validation catalog

> **Specialized contributor reference.** Ordinary users should start from [`../APPLE_USAGE.md`](../APPLE_USAGE.md). Current support claims live in [`../hardware/APPLE_SILICON.md`](../hardware/APPLE_SILICON.md) and accepted artifacts; commands below are contribution and evidence-collection recipes.
