...
| AMD gfx1100 | Exact-card fused decode is `1.3658x-2.0402x` conservative native across 0.1B-2.9B B1/B8 | Output-head W8/W4 beats fp16 cached decode in 24/24 0.4B-2.9B B1/B2/B4/B8 rows; full-model quant remains below fp16 | Dense and head-quant greedy parity pass; 2.9B full-model W4 quality fails | Validated named decode lanes |
