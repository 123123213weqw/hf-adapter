...
|---|---|---|---|---|
| RTX 3090 | latest g1d/g1i 0.4B-7.2B vs full-FLA Qwen3.5 B1/B8, P128/512/2048: raw prefill min/median `1.531589x/2.076170x`, parameter-adjusted min/median `1.227477x/1.467758x` | Earlier B8 W8/W4 total/decode and footprint lanes remain retained | 24/24 full-FLA references and 25/25 FP32-vs-FP16-accum prompt/cache-handoff rows pass; task quality not measured | Production-close for latest-checkpoint prefill and retained quant lanes |
