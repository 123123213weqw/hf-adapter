...
| RTX 4080 | 0.4B/0.8B, 1.5B/2B and 2.9B/4B B1/B8 full-FLA-Qwen matrices; dense prefill/decode minimum `1.012285x/1.435296x`, active-work decode `1.768344x`; exact-B8 grouped projection adds `1.1267x/1.0942x/1.0809x` over the prior route | output-head A8W8/W4 complete-cell minima `1.003101x/1.015996x`; full-model BNB routes lower footprint; 13.3B MM8/MM4 fit | Qwen full-FLA contracts 36/36; exact-B8 logits and greedy `4,608/4,608`; output-head cosine/greedy gates pass; 13.3B is capacity-only without fp16 parity | Production-close for measured Native HF B1/B8 and capacity lanes |
