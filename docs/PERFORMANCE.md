...
|---|---|---|---|---|
| RTX 3090 | latest g1d/g1i 0.4B-7.2B vs full-FLA Qwen3.5 B1/B8, P128/512/2048: raw prefill min/median `1.393044x/1.856646x`, parameter-adjusted min/median `1.037869x/1.351562x` | Earlier B8 W8/W4 total/decode and footprint lanes remain retained | 24/24 full-FLA references and 15/15 FP32-vs-FP16-accum prompt/cache-handoff rows pass; task quality not measured | Production-close for latest-checkpoint prefill and retained quant lanes |
...
| RTX 4080 | 0.4B/0.8B, 1.5B/2B and 2.9B/4B B1/B8 full-FLA-Qwen matrices; adjusted Prefill/Decode pass 36/36 cells each with minima `1.068520x/1.140700x`; adjusted E2E group medians also remain ahead; exact-B8 grouped projection and 7.2B/B8 FP16-state lanes remain | output-head A8W8/W4 complete-cell minima `1.003101x/1.015996x`; full-model BNB routes lower footprint; 7.2B/B8 FP16 state saves median `123.88 MiB`; 13.3B MM8/MM4 fit | exact full-Prefill/block-only FP16-accumulation promotion passes greedy `18/18` for both Prefill and Decode with cosine above `0.9999`; Qwen full-FLA contracts, 7.2B state, and output-head gates pass | Production-close for measured Native HF B1/B8 and capacity lanes |
