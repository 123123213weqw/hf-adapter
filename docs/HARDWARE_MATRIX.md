...
| RTX 3090 24GB, sm86 | **Production-close for latest-checkpoint B1/B8 prefill and retained quant lanes** | g1d/g1i 0.4B/1.5B/2.9B/7.2B vs Qwen3.5 0.8B/2B/4B/9B; earlier B8 W8/W4 | Strict per-cell parameter-adjusted prefill passes 24/24 at minimum/median `1.037869x/1.351562x`; 24/24 full-FLA references and 15/15 prompt/cache-handoff correctness rows pass | B2/B4 latest checkpoints, task-quality evaluation, multi-GPU and broader Ampere portability |
...
- RTX 3090 latest-checkpoint parameter-adjusted prefill: [`../bench/3090_g1i_qwen35_prefill_pd_20260812/README.md`](../bench/3090_g1i_qwen35_prefill_pd_20260812/README.md)
