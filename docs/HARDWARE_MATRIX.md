...
| RTX 4090 24GB, sm89 | **Production-close for latest dense-FP16 B1/B8 and measured quant lanes** | RWKV 0.4B/1.5B/2.9B/7.2B vs Qwen3.5 0.8B/2B/4B/9B; dense FP16 B1/B8 plus historical W8/W4 B8 | Best-optimized HF matrix passes 96/96 protocol rows and 48/48 adjusted Prefill plus 48/48 adjusted Decode cells at minima `1.060506x/1.829468x`; 7.2B B8/P2048 fits with Prefill Graph off and Decode Graph on | B2/B4 latest matrix, task quality, full-memory W4, other Ada cards |
...
- RTX 4090 unified best-optimized HF: [`../bench/4090_hf_best_optimized_v1_20260812/README.md`](../bench/4090_hf_best_optimized_v1_20260812/README.md)
