...
_RUNTIME_NAMES = ('A', 'B', 'D', 'H', 'Kw', 'N', 'Ow', 'RKVw', 'Rw', 'Vw', '_graph_linear_call', '_graph_linear_call_with_explicit_bias', '_graph_linear_is_dense', '_graph_linear_shape', '_graph_linears_are_dense', '_init', '_linear_module', '_lm_head', '_native_graph_ada_wag_lora_enabled', '_native_graph_ada_wagv_lora_enabled', '_native_graph_blackwell_norm_mix_enabled', '_native_graph_ffn_dispatch', '_native_graph_fp16_recurrent_enabled', '_native_graph_fused_norm_mix_enabled', '_native_graph_fused_norm_mix_num_warps', '_native_graph_fused_output_enabled', '_native_graph_fused_output_project_block_m', '_native_graph_fused_output_project_enabled', '_native_graph_fused_projection_enabled', '_native_graph_fused_recurrent_output_enabled', '_native_graph_fused_recurrent_raw_enabled', '_native_graph_fused_wag_lora_blocks', '_native_graph_fused_wag_lora_enabled', '_native_graph_fused_wavg_lora_blocks', '_native_graph_fused_wavg_lora_enabled', '_native_graph_fused_wavg_lora_num_warps', '_native_graph_linear_dispatch', '_native_graph_rkv_project', '_native_graph_sm70_wagv_lora_enabled', '_native_graph_vkwr_rkv_dispatch', '_recurrent_update_batched', '_recurrent_update_unbatched', 'a', 'a0', 'a1', 'a2', 'ada_wag_lora', 'ada_wagv_lora', 'an_b', 'an_w', 'base', 'blackwell_ffn_add_norm_mix', 'block_k', 'block_m', 'block_r', 'block_step', 'block_step_batched', 'device', 'dt', 'dtype', 'emb', 'eps', 'equal_width', 'extract', 'fK', 'fV', 'fk', 'fn', 'fn_b', 'fn_w', 'fp16_advance_elapsed', 'fp16_elapsed', 'full', 'fused_attn_norm_mix6_decode', 'fused_attn_output_prepare', 'fused_attn_output_project', 'fused_ffn_add_norm_mix_decode', 'fused_recurrent_output_prepare', 'fused_recurrent_output_prepare_raw', 'fused_rkv_wavg_projection', 'fused_wag_lora', 'fused_wavg_lora', 'fx_k', 'fxx', 'g', 'g1', 'g2', 'gn_b', 'gn_w', 'h', 'h2', 'has_pre', 'head', 'hid', 'i', 'ids', 'k', 'k_a', 'k_k', 'kk', 'li', 'logits', 'lora_dense', 'max_new_tokens', 'model', 'n', 'nL', 'native_fp16_recurrent_output_prepare_raw', 'nb', 'new_state', 'new_tokens', 'norm_b', 'norm_w', 'nt', 'nw', 'nx', 'one_step', 'out', 'p', 'packs', 'pre_b', 'pre_w', 'prompt', 'r', 'r_k', 'residual', 's', 'sk', 'sm70_wagv_lora', 'sparse_ffn_out', 'st_s', 'stack_rkv', 'state', 't', 't0', 'tok_id', 'tok_s', 'tokenizer', 'toks', 'use_fp16_recurrent', 'use_fused_norm_mix', 'use_fused_recurrent_output', 'use_fused_recurrent_raw', 'use_graph', 'v', 'v0', 'v1', 'v2', 'v_first', 'v_gate', 'v_mixed', 'vf_s', 'w', 'w0', 'w1', 'w2', 'x', 'x_a', 'x_g', 'x_k', 'x_r', 'x_v', 'x_w', 'xa', 'xg', 'xk', 'xpa', 'xpa_s', 'xpf', 'xpf_s', 'xr', 'xv', 'xw', 'xx')
