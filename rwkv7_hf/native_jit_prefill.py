...
_RUNTIME_NAMES = ('B', 'H', 'Kw', 'N', 'Ow', 'Rw', 'T', 'Vw', '_FP16_ACCUMULATION_LOCK', '_bnb8_direct_linear', '_bnb8_direct_relu_square_linear', '_bnb8_ffn_mix_quant_enabled', '_bnb8_prequant_linear', '_bnb8_rkv_mix_quant_enabled', '_graph_linear_is_dense', '_graph_linears_are_dense', '_init_batched_from_packs', '_lm_head', '_native_bnb8_policy_block', '_native_prefill_attn_shift_mix_block_size', '_native_prefill_dplr_chunk_size', '_native_prefill_dplr_scan_enabled', '_native_prefill_ffn_shift_mix_block_size', '_native_prefill_fp16_accum_ffn_key_enabled', '_native_prefill_fp16_accum_ffn_key_layers', '_native_prefill_fp16_recurrent_enabled', '_native_prefill_fp16_recurrent_requested', '_native_prefill_fused_clampw_scan_enabled', '_native_prefill_fused_output_enabled', '_native_prefill_fused_output_project_block_m', '_native_prefill_fused_output_project_enabled', '_native_prefill_fused_residual_gemm_enabled', '_native_prefill_fused_scan_enabled', '_native_prefill_fused_scan_output_enabled', '_native_prefill_fused_sequence_ffn_enabled', '_native_prefill_fused_shift_mix_enabled', '_native_prefill_fused_state_prep_enabled', '_native_prefill_fused_state_scan_enabled', '_native_prefill_fused_wavg_lora_blocks', '_native_prefill_fused_wavg_lora_enabled', '_native_prefill_model_shape_selected', '_native_prefill_policy_model_shape_selected', '_native_prefill_scan_block_m', '_native_prefill_scan_num_warps', '_native_prefill_self_chunk_enabled', '_native_prefill_self_chunk_h_tiles', '_native_prefill_self_chunk_safe_gate', '_native_prefill_self_chunk_size', '_native_prefill_sequence_ffn_blocks', '_native_prefill_sequence_ffn_launch', '_native_prefill_shift_mix_layers', '_native_prefill_shift_mix_num_warps', '_native_prefill_stacked_rkv_enabled', '_native_prefill_state_prep_layers', '_native_prefill_state_prep_w_dtype', '_recurrent_update_batched', 'a', 'a0', 'a1', 'a2', 'a_mid', 'allow_fp16_accumulation', 'an_b', 'an_w', 'attention_hidden', 'attn_shift_mix_block_size', 'attn_shift_mix_num_warps', 'base', 'bias', 'block_k', 'block_m', 'block_r', 'bnb8_attn_mix_workspace', 'bnb8_attn_quant_workspace', 'bnb8_attn_scale_workspace', 'bnb8_ffn_quant_workspace', 'bnb8_ffn_scale_workspace', 'cached', 'can_select_accumulation', 'capture_layer_outputs', 'chunk_size', 'clampw_scan_used', 'cur_state', 'defer_state_sigmoid', 'direct', 'dplr_chunk_scan', 'dtype', 'env_flag', 'eps', 'fK', 'fV', 'ffn_out', 'ffn_shift_mix_block_size', 'ffn_shift_mix_num_warps', 'ffn_up_prequantized', 'fk', 'fn_b', 'fn_w', 'fp16_accum_ffn_key_layer', 'fp16_accum_ffn_key_layers', 'fp16_accum_ffn_key_used', 'fp16_elapsed', 'fp16_w0', 'fused', 'fused_attn_output_prepare', 'fused_attn_output_project', 'fused_attn_sequence_shift_mix', 'fused_bnb8_attn_sequence_mix_quant', 'fused_bnb8_ffn', 'fused_bnb8_ffn_sequence_mix_quant', 'fused_ffn_sequence_shift_mix', 'fused_prefill_kv_kk_prep', 'fused_prefill_state_prep', 'fused_recurrent_scan', 'fused_recurrent_scan_clampw', 'fused_recurrent_scan_output_prepare', 'fused_recurrent_scan_state_prep', 'fused_relu_square', 'fused_relu_square_available', 'fused_sequence_ffn', 'fused_up_relu2', 'fused_wavg_lora', 'fx_k', 'fxx', 'g', 'g1', 'g2', 'g_mid', 'gn_b', 'gn_w', 'h', 'h2', 'has_pre', 'hidden', 'i', 'ids', 'k', 'k_a', 'k_k', 'keep', 'key', 'kk', 'kw', 'layer_idx', 'layer_outputs', 'logits', 'logits_to_keep', 'matmul', 'model', 'native_fp16_sequence', 'new_state', 'next_xpa', 'next_xpf', 'num_layers', 'operand', 'out', 'out_projected', 'outs', 'p', 'packed', 'packs', 'pre_b', 'pre_w', 'prefill_shift_mix_layers', 'prefill_state_prep_layers', 'prequantized_rkv', 'prev_h', 'prev_h2', 'previous', 'qfk', 'qk', 'qr', 'qv', 'r', 'r_k', 'residual', 'residual_hidden', 'rkv', 'rkv_inputs', 'row_values', 'rw', 's', 'scan_block_m', 'scan_num_warps', 'self_chunk_rwkv7', 'self_chunk_used', 'self_chunk_w_is_log', 'sequence_attn_mix_workspace', 'sequence_ffn_blocks', 'sequence_ffn_launch', 'sequence_ffn_mix_workspace', 'sequence_ffn_used', 'sequence_ffn_workspace', 'sfk', 'signatures', 'sk', 'sr', 'stacked_rkv_used', 'stacked_rkv_weights', 'state', 'state_dtype', 'state_scan_done', 'state_sigmoid_is_raw', 'strict_attn_default', 'strict_attn_shift_mix_fp16', 'strict_ffn_default', 'strict_ffn_shift_mix_fp16', 'strict_shift_mix_fp16', 'sv', 't', 'use_bnb8_rkv_mix', 'use_clampw_scan', 'use_clampw_scan_requested', 'use_fp16_accum_ffn_key', 'use_fp16_recurrent', 'use_fp16_recurrent_requested', 'use_fused_scan_output', 'use_fused_state_scan', 'use_layer_attn_shift_mix', 'use_layer_ffn_shift_mix', 'use_layer_sequence_ffn', 'use_layer_shift_mix', 'use_layer_state_prep', 'use_prefill_output', 'use_prefill_sequence_ffn', 'use_prefill_shift_mix', 'use_prefill_state_prep', 'use_prefill_wavg_lora', 'use_self_chunk', 'use_sequence_attn_mix', 'use_stacked_rkv', 'v', 'v0', 'v1', 'v2', 'v_first_seq', 'v_gate', 'v_mid', 'vw', 'w', 'w0', 'w1', 'w2', 'w_is_log', 'w_is_raw', 'w_mid', 'wavg_lora_used', 'weight', 'x', 'x_a', 'x_for_logits', 'x_g', 'x_k', 'x_r', 'x_v', 'x_w', 'xa', 'xg', 'xk', 'xpa', 'xpf', 'xr', 'xv', 'xw', 'xx')
