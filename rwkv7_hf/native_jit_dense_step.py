# coding=utf-8
"""Pure dense TorchScript RWKV-7 per-layer decode steps.

These functions preserve the historical tensor-only pack ABI used by the
native JIT runner.  They intentionally contain no hardware policy, optional
kernel dispatch or model-container logic.
"""
