"""Process-wide actual-route trace shared by recurrent and model protocols."""
...
def write_trace() -> None:
    ...
    if not destination or not (_RECURRENT or _MODEL):
        return
    ...
    payload = {
        ...
        "requested_model_policy": os.environ.get(
...
__all__ = ["record_model", "record_recurrent", "write_trace"]
