...
Rows are JSON-serializable so they can be appended to `bench/_runs/results.jsonl` and
...
def bench_ttft(args, model) -> list[dict[str, Any]]:
    ...
    for isl in args.isl:
        ...
        row = {
            ...
            "fast_prefill_env": os.environ.get("RWKV7_FAST_PREFILL", "0"),
            "native_prefill_fused_scan_env": os.environ.get("RWKV7_NATIVE_PREFILL_FUSED_SCAN", "0"),
            "fast_prefill_backend_effective": getattr(model, "rwkv7_last_fast_prefill_backend", lambda: None)(),
