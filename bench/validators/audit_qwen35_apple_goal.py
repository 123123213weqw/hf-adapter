...
# When this file is executed as ``python bench/validators/audit_qwen35_apple_goal.py``,
...
# ``bench.analyzers.compare_qwen35_apple_baseline`` imports.
sys.path = [entry for entry in sys.path if Path(entry or ".").resolve() != SCRIPT_DIR]
if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))

from bench.analyzers.compare_qwen35_apple_baseline import BASELINE_AXIS, COMPARISON_AXIS, memory_bytes, requested_tokens, row_model_id, safe_float, safe_int
