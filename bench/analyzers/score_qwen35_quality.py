...
This script consumes rows from ``bench/runners/run_qwen35_apple_baseline.py``.  It only
...
def main() -> int:
    ...
    ap.add_argument("--results", required=True, help="Input JSONL from bench/runners/run_qwen35_apple_baseline.py")
