...
Examples:
  python bench/analyzers/summarize_results.py --results bench/_runs/results.jsonl --device V100 --last 12
  python bench/analyzers/summarize_results.py --axis speed_mem --require-fast-decode
"""
...
def compact(row: dict[str, Any]) -> dict[str, Any]:
    keys = [
        ...
        "avg_timings_ms", "avg_current_linears_lora_sum_ms",
        "avg_candidate_linears_lora_sum_ms", "avg_candidate_speedup",
        ...
        "decode_ms_per_step", "decode_ms_per_token", "decode_greedy_tokps", "decode_fixed_tokps",
