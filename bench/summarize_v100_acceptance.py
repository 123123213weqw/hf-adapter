#!/usr/bin/env python3
"""Fail-closed summary for the 2026-07-16 V100 evidence snapshot."""
    ...
    return {
        ...
        "open_gpu_gates": [
            ...
            },
            {
                ...
                "detail": (
                    "At the snapshot date, historical PR #21 recorded MM4 speed with "
                    "greedy mismatches and MM8 at 0/21 speed cells per model; no "
                    "full-memory path was promoted by this snapshot."
                ),
            },
            {
        ...
        "not_claimed": [
            ...
            "current V100 status after 2026-07-16",
        ],
        "errors": errors,
    }
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "This validates the dated snapshot only; use `HF_STATUS.md`, `BENCHMARK.md`, "
        "and `docs/HARDWARE_MATRIX.md` for current conclusions.",
        "",
