...
#
# Usage:
#   bench/runners/run_rkv_policy_ab.sh <hf_dir> [dtype=fp16] [batch=1]
# Example (V100):
#   bench/runners/run_rkv_policy_ab.sh /home/data/wangyue/models/rwkv7/rwkv7-g1d-0.1b-hf fp16 1
set -euo pipefail
...
export RWKV_V7_ON=1
"$PY" bench/probes/bench_native_graph_vkwr_rkv_policy.py \
