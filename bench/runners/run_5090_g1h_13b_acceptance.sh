...
if ! "${PYTHON_BIN}" "${ROOT}/bench/validators/check_exact_gpu.py" \
...
"${PYTHON_BIN}" bench/probes/bench_larger_model_smoke.py \
...
"${PYTHON_BIN}" bench/runners/run_blackwell_quant_matrix.py \
...
"${PYTHON_BIN}" bench/analyzers/summarize_blackwell_quant_matrix.py \
