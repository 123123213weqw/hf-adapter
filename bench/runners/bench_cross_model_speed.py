...
from bench.benchlib.model_loader import load_causal_lm, load_tokenizer  # noqa: E402
from bench.benchlib.results import append_jsonl  # noqa: E402
from bench.benchlib.timing import synchronize  # noqa: E402
...
def prepare_rwkv_model_dir(
    ...
    repo_code = Path(__file__).resolve().parents[2] / "rwkv7_hf"
...
def load_model(
    ...
    if args.model_kind == "rwkv":
        ...
        if implementation == "wrapper_repo":
            ...
            model = load_causal_lm(model_path or args.model, **kwargs)
            effective = (
                "native_model"
    ...
    if getattr(args, "qwen_conv_backend", "auto") == "fla_triton":
        try:
            from bench.probes.qwen35_fla_triton_conv import bind_qwen35_fla_triton_conv
...
_QWEN35_FLA_TRITON_CONV_PREFIXES = (
    "bench.probes.qwen35_fla_triton_conv",
