...
Example:
  ...
  python bench/runners/run_blackwell_quant_matrix.py \\
...
from bench.benchlib.paths import BENCH_ROOT
...
def main() -> int:
    ...
    ap.add_argument("--results", default=str(BENCH_ROOT / "_runs/results_5090_blackwell_quant_matrix.jsonl"))
    ap.add_argument("--baseline-dir", default=str(BENCH_ROOT / "_runs/blackwell_quant_baselines"))
