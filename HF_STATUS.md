...
| Native/no-FLA backend | **PASS for HF compatibility and exact measured Native lanes** | load/generate/cache/PEFT/Trainer/TRL pass; exact RTX 5090 Native training is `1.00049x` official by paired-seed median and `1.00255x` over 5,000 steps; RTX 5090 7.2B fp16-state decode is `1.0010x/1.0104x`, 2.9B/13.3B B1/B8 prefill passes 12/12 same-precision cells, and the RTX 4080 7.2B/B8 native-graph FP16-state route passes its exact-card speed/memory/correctness gate |
...
| Production performance | **PASS for declared exact-card profiles** | V100 Albatross/native-quant lanes plus 1.5B/full-FLA-Qwen B1/B8 active-work gates; RTX 4080 now also has promoted B8 grouped-projection and 7.2B FP16-state decode routes; RTX 4090, RTX 5070, RTX 5090 and Apple M5 retain promoted exact-card artifacts for their named shapes; additional profiles are post-release expansion |
...
|---|---|---|
| V100 32GB | **Production-close for measured lanes** | Dense Albatross/Qwen lanes are retained; packed MM4 cached decode passes exact 1.5B memory+group128+fused, 2.9B group256 speed and 7.2B memory profiles 7/7 each. The separate 1.5B speed/group256 P128/D128 matrix passes B1/B2/B4/B8 prefill/decode at minima `1.0032x/1.0011x` with `0.9344x` footprint. The exact-V100 B8 WAVG launch adds paired `1.0114x-1.0312x` decode gains on 0.4B/1.5B/2.9B with greedy parity; B1/B2/B4 and non-V100 sm70 products keep their prior route. Long-row dequant+BLAS raises 1.5B full-memory B1/B8 prefill to `0.7816x/0.9076x`; wider full-memory shapes are post-release extensions; [`bench/4080_v100_decode_tuning_20260808/`](bench/4080_v100_decode_tuning_20260808/README.md), [`bench/v100_sm70_prefill_dequant_20260723/`](bench/v100_sm70_prefill_dequant_20260723/README.md), [`bench/v100_sm70_mm4_bntn_20260716/`](bench/v100_sm70_mm4_bntn_20260716/README.md), [`bench/v100_active_b1b8_20260715/`](bench/v100_active_b1b8_20260715/README.md) |
