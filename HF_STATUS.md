...
| RTX 3090 | **Production-close for latest-checkpoint B1/B8 prefill and retained quant lanes** | The max-performance g1d/g1i 0.4B/1.5B/2.9B/7.2B matrix passes all 24 parameter-adjusted prefill cells versus full-FLA/Triton-conv Qwen3.5 at minimum/median `1.227477x/1.467758x`; raw prefill minimum is `1.531589x`. All 25 FP32-vs-FP16-accum prompt/cache-handoff rows pass cosine `>=0.9999` and exact greedy checks. Earlier B8 W8/W4 lanes remain valid; task quality and other Ampere products/shapes are separate; [`bench/3090_g1i_qwen35_maxperf_20260812/`](bench/3090_g1i_qwen35_maxperf_20260812/README.md) |
