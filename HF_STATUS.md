...
| Full common-card coverage | **PARTIAL** | Tesla T4 and AMD gfx1100 compatibility are validated; H100, AMD fused/quantized performance, other Turing products and broader Apple/50-series evidence remain open |
...
| AMD gfx1100 / ROCm 7.2.1 | **Validated compatibility** | Fully native HF AutoModel/generate, PEFT, recurrent cache/chunked prefill and bf16 Trainer pass on 0.1B; fused prefill/decode, HIP W8/W4, larger models and MI-series remain open; [`docs/validation/AMD_ROCM_HF_VALIDATION.md`](docs/validation/AMD_ROCM_HF_VALIDATION.md) |
