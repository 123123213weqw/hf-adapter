...
| Full common-card coverage | **PARTIAL** | Tesla T4 and AMD gfx1100 compatibility are validated; gfx1100 exact decode and output-head W8/W4 lanes now pass through 2.9B, while H100, AMD prefill/full-model quant, other Turing products and broader Apple/50-series evidence remain open |
...
| AMD gfx1100 / ROCm 7.2.1 | **Validated with exact-card decode lanes** | Fully native HF/PEFT/cache/chunked-prefill/bf16 Trainer pass; fused decode passes through 2.9B and output-head W8/W4 beats fp16 decode in 24/24 B1/B2/B4/B8 rows. Fused prefill, full-model quant, 7.2B/13.3B and MI-series remain open; [`docs/validation/AMD_ROCM_HF_VALIDATION.md`](docs/validation/AMD_ROCM_HF_VALIDATION.md) |
